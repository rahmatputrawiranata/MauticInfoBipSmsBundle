    ...
    'services' => [
        'events' => [
            'mautic.sms.infobipcampaignbundle.subscriber' => [
                'class'     => \MauticPlugin\MauticInfoBipSmsBundle\EventListener\CampaignSubscriber::class,
                'arguments' => [
            ...
            'mautic.sms.mauticinfobipsmsbundle.subscriber' => [
                'class'     => \MauticPlugin\MauticInfoBipSmsBundle\EventListener\SmsSubscriber::class,
                'arguments' => [
